...
describe('get and result', function () {
  ...
  it('should return `undefined` when `object` is nullish', function () {
    expect(get(null as any, 'constructor')).toBe(undefined)
    expect(get(null as any, ['constructor'])).toBe(undefined)
    expect(get(undefined as any, 'constructor')).toBe(undefined)
    expect(get(undefined as any, ['constructor'])).toBe(undefined)
  })

  it('should return `undefined` for deep paths when `object` is nullish', function () {
    expect(get(null as any, 'constructor.prototype.valueOf')).toBe(undefined)
    expect(get(null as any, ['constructor', 'prototype', 'valueOf'])).toBe(
      undefined
    )
    expect(get(undefined as any, ['constructor', 'prototype', 'valueOf'])).toBe(
      undefined
    )
    expect(get(undefined as any, ['constructor', 'prototype', 'valueOf'])).toBe(
      undefined
  ...
  it('should follow `path` over non-plain objects', function () {
    ...
    // @ts-ignore
    numberProto.a = { b: 2 }
    expect(get(0 as any, 'a.b')).toBe(2)
    expect(get(0 as any, ['a', 'b'])).toBe(2)
    // @ts-ignore
